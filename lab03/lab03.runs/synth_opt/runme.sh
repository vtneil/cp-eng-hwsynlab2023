...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab03/lab03.runs/synth_opt'
cd "$HD_PWD"
...
EAStep vivado -log quad_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quad_bcd.tcl
