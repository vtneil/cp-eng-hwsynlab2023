...
REM
REM Generated by Vivado on Tue Sep 12 13:30:59 +0700 2023
...
echo "xvlog --incr --relax -prj sim_bcd_cnt_vlog.prj"
call xvlog  --incr --relax -prj sim_bcd_cnt_vlog.prj -log xvlog.log
