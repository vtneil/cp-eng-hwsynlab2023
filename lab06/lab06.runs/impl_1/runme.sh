...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab06/lab06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_uart.tcl -notrace
