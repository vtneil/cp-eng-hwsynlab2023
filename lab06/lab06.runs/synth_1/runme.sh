...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab06/lab06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_uart.tcl
