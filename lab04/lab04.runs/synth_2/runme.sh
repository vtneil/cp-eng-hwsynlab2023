...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab04/lab04.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log system_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_1.tcl
