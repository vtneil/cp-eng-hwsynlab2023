...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab04/lab04.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log system_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_3.tcl -notrace
