...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab05/lab05.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log nano_03_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nano_03_system.tcl -notrace
