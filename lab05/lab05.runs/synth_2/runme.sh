...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab05/lab05.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log nano_03_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nano_03_system.tcl
