...
HD_PWD='C:/Users/vivat/Desktop/cp-eng-hwsynlab2023/lab05/lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nano_031_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nano_031_system.tcl
