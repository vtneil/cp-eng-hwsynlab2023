...
rom 	#(.PROG_FILE("lab05_02.mem"), .ADDR_WIDTH(ADDR_WIDTH)) PROGMEM(p_data,p_address[ADDR_WIDTH + 1:2]);
memory 	#(.DATA_FILE("empty32x16.mem"), .ADDR_WIDTH(ADDR_WIDTH)) DATAMEM(d_data,d_address[ADDR_WIDTH -1:0],mem_wr,clock);
