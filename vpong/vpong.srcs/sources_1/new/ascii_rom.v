...
module ascii_rom(
    ...
    always @(*) begin
        case(addr_reg)
            ...
            11'h327: data = 8'b00111100;    //  #### 
            11'h328: data = 8'b11100000;    //###
            ...
            11'h5b1: data = 8'b11111000;    //
            11'h5b2: data = 8'b11111000;    //
            11'h5b3: data = 8'b11000000;    //
            11'h5b4: data = 8'b11000000;    //
            11'h5b5: data = 8'b11000000;    //
            11'h5b6: data = 8'b11000000;    //
            11'h5b7: data = 8'b11000000;    //
            11'h5b8: data = 8'b11000000;    //
            11'h5b9: data = 8'b11000000;    //
            11'h5ba: data = 8'b11000000;    //
            11'h5bb: data = 8'b11000000;    //
            11'h5bc: data = 8'b11111000;    //
            11'h5bd: data = 8'b11111000;    //
            ...
            11'h5d1: data = 8'b00111110;    //
            11'h5d2: data = 8'b00111110;    //
            11'h5d3: data = 8'b00000110;    //
            11'h5d4: data = 8'b00000110;    //
            11'h5d5: data = 8'b00000110;    //
            11'h5d6: data = 8'b00000110;    //
            11'h5d7: data = 8'b00000110;    //
            11'h5d8: data = 8'b00000110;    //
            11'h5d9: data = 8'b00000110;    //
            11'h5da: data = 8'b00000110;    //
            11'h5db: data = 8'b00000110;    //
            11'h5dc: data = 8'b00111110;    //
            11'h5dd: data = 8'b00111110;    //
