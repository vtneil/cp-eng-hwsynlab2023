...
#
# Script generated by Vivado on Sat Dec 09 00:28:28 +0700 2023
...
#
# Usage        : CW.sh
#                CW.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CW.sh [-reset_run]
#                CW.sh [-reset_log]
#                CW.sh [-help]
#
...
#                script (type 'CW.sh -help' for more information).
#
...
# script info
echo -e "CW.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CW.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.CW xil_defaultlib.glbl -o CW_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./CW_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key CW_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc CW_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CW.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CW.sh [-help]\n\
Usage: CW.sh [-step]\n\
Usage: CW.sh [-lib_map_path]\n\
Usage: CW.sh [-reset_run]\n\
Usage: CW.sh [-reset_log]\n\
Usage: CW.sh [-keep_index]\n\
Usage: CW.sh [-noclean_files]\n\n\
