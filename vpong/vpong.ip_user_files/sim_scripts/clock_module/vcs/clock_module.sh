...
#
# Script generated by Vivado on Fri Dec 08 11:46:00 +0700 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clock_module.sh
...
#
# Usage        : clock_module.sh
#                clock_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_module.sh [-reset_run]
#                clock_module.sh [-reset_log]
#                clock_module.sh [-help]
#
...
#                script (type 'clock_module.sh -help' for more information).
#
...
# script info
echo -e "clock_module.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clock_module xil_defaultlib.glbl -o clock_module_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clock_module_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clock_module_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clock_module_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clock_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clock_module.sh [-help]\n\
Usage: clock_module.sh [-step]\n\
Usage: clock_module.sh [-lib_map_path]\n\
Usage: clock_module.sh [-reset_run]\n\
Usage: clock_module.sh [-reset_log]\n\
Usage: clock_module.sh [-keep_index]\n\
Usage: clock_module.sh [-noclean_files]\n\n\
